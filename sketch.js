...
function draw() {
  ...
  if(gameState===1){
    ...
    if (wildanimalGroup.collide(backBoard)){
      handleGameover(wildanimalGroup);
    }
    ...
    if(domanimalGroup.collide(bulletGroup)){
      handleAnimalCollision(domanimalGroup);
...
break;
  case 6 : wildAnimals.addImage(wildImg6)
default: break;
...
function domAnimal(){
  ...
  break;
    case 3 : domAnimals.addImage(domImg3)
  break;
    case 4 : domAnimals.addImage(domImg4)
  break;
    case 5 : domAnimals.addImage(domImg5)
  break;
    case 6 : domAnimals.addImage(domImg6)
  default: break;
...
function handleGameover(animalGroup){
